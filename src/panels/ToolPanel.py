...
class ToolPanel(Frame):
    ...
    def __create_widgets(self):
        ...
        menu.add_radiobutton(label="opcionx", value="opcionx", variable=self.__opcion_escogida,
                             command=self.__actualizar_panel)
        menu.add_radiobutton(label="opciony", value="opciony", variable=self.__opcion_escogida,
                             command=self.__actualizar_panel)
        menu.add_radiobutton(label="opcionz", value="opcionz", variable=self.__opcion_escogida,
                             command=self.__actualizar_panel)
        ...
        menu.add_radiobutton(label="Opcion a", value="Opcion a", variable=self.__opcion_escogida)
        menu.add_radiobutton(label="Opcion b", value="Opcion b", variable=self.__opcion_escogida)
        ...
        menu.add_radiobutton(label="Rectangle", value="rec", variable=self.__opcion_escogida,
                             command=self.__actualizar_panel)
        menu.add_radiobutton(label="Circle", value="cir", variable=self.__opcion_escogida,
                             command=self.__actualizar_panel)
        menu.add_radiobutton(label="Line", value="lin", variable=self.__opcion_escogida,
                             command=self.__actualizar_panel)
